---
description: Manage state with custom field policies in Apollo Client queries with local-only fields. Includes examples of storing data in reactive variables or the Apollo Client cache itself.
---
