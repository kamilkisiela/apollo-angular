---
description: Learn to use multiple Apollo clients in your Angular application with @apollo_angular. Create named clients and configure using APOLLO_NAMED_OPTIONS token.
---
