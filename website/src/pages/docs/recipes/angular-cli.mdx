---
description: Learn how to integrate Apollo with Angular using ng add apollo-angular. Use Angular CLI Proxy to define configurations for your GraphQL endpoint
---
# Angular CLI
