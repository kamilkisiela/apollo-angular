---
description: Learn how to customize cached fields in Apollo Client by defining field policies with read and merge functions. Optimize your cache with key arguments. Read more at the Apollo Client documentation.
---
