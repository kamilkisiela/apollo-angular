...
Please read the ["Reading and writing data to the cache"](https://apollographql.com/docs/react/caching/cache-interaction) chapter on Apollo Client documentation.
