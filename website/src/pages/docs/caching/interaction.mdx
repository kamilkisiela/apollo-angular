---
description : Learn how to efficiently read and write data to the cache with Apollo Client. Check out the "Reading and writing data to the cache" chapter in the Apollo Client documentation.
---
