---
description: Learn how to manage cached data in Apollo Client 3 with garbage collection and cache eviction strategies, and gain fine-grained control with the evict method. Read more on the documentation.
---
