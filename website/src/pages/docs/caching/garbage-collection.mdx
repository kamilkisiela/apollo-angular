...
Please read the ["Garbage collection and cache eviction"](https://apollographql.com/docs/react/caching/garbage-collection) chapter on Apollo Client documentation.
