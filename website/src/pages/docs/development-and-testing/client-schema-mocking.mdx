---
description: Learn how to use client schemas to add a new field to an existing type in your schema using mock data, with Apollo Client and GraphQL queries.
---
