---
description: Using TypeScript with GraphQL and Angular and making everything type safe
---
...
even generate TypeScript definitions automatically using a tool like
...
Without specifying a Generic Type for `Apollo.watchQuery`, TypeScript would throw
