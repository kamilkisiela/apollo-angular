---
description: Learn how to test apollo-angular code using Jest with ApolloTestingModule. It allows for easy mocking of calls to the GraphQL endpoint, so tests can run in isolation and produce consistent results.
---
