...
<Callout>
  We recommend you to read ["Testing HTTP requests"](https://angular.io/guide/http#testing-http-requests) chapter of
  Angular docs.
</Callout>
...
- `flush(result: ExecutionResult | ApolloError): void{:ts}` - it accepts a result object or ApolloError instance
