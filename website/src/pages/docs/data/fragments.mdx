---
description:  Learn how to use GraphQL Fragments with Apollo client in this tutorial. GraphQL fragments let you share query logic between multiple queries, mutations, or subscriptions, allowing you to co-locate field access with the places they are used. You can also define fragments on unions and interfaces, and use patterns in Apollo client to take full advantage of it.
---
# Using Fragments
