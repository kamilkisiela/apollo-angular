---
description: Interacting with local data in Apollo Client. Learn how to store local state in reactive variables or the cache, and how to query local-only fields.
---
