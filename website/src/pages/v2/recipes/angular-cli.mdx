---
description:
  Angular integration for Apollo Client. Apollo Client is a fully-featured, production ready caching
  GraphQL client for every UI framework and GraphQL server.
---
