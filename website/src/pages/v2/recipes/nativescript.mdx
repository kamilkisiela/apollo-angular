...
To introduce Apollo to your app, install `apollo-angular` from npm and use them in your app as outlined in the [setup](../get-started) article:

<PackageCmd packages={['apollo-angular']} />

<Callout>**Note**: There are more packages to be installed, so check out the "initialization" article.</Callout>
...
<Callout>If you've got an example to post here, please hit the "Edit on GitHub" button above and let us know!</Callout>
