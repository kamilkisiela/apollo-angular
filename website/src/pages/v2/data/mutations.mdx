---
description: Update data with the Apollo.mutate. Learn how to use mutations in Apollo Angular.
---
...
<Callout>
  As this comment is _new_ and not visible in the UI before the mutation, it won't appear
