---
description:
  Learn how to use Apollo Client to manage local state. You can use Apollo Client to store local
  data in the cache, and to read and write local data to the cache.
---
