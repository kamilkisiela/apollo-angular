---
description: What is Apollo Angular and what does it do?. Learn how to use Apollo Angular to build a GraphQL client.
---
...
[Apollo](https://nasa.gov/mission_pages/apollo/missions/index.html) Angular is the ultra-flexible,
...
1. **Features**, which showcase some of the advanced capabilities of Apollo Angular that your app
   may need.
...
- **Angular Router**: Apollo Client is completely router-independent, which means you can use it
  ...
  [server-side rendering](./v2/performance/improving-performance).
