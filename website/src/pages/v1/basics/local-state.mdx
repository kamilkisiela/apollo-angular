...
@Component({
  selector: 'todo',
  template: `
    <li *ngIf="task" (click)="toggle()" [ngStyle]="{ textDecoration: task.completed ? 'line-through' : 'none' }">
      {{ task.text }}
    </li>
  `,
})
...
export class TodoListComponent implements OnInit {
  ...
  ngOnInit() {
    this.todos = this.apollo
      ...
      .valueChanges.pipe(map(({ data }) => this.getVisibleTodos(data.todos, data.visibilityFilter)));
  }
