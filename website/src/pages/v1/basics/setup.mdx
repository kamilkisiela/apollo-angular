---
description:
  Apollo Angular is a community-maintained Angular integration for Apollo Client. It provides you
  with everything you need to use Apollo Client in your Angular app.
---
