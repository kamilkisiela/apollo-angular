---
description:
  A guide to customizing and directly accessing your Apollo cache. Learn how to read and write data
  to your cache, and how to configure your cache to work with your data.
---
