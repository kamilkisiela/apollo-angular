...
[Apollo Client](https://nasa.gov/mission_pages/apollo/missions/index.html) is the ultra-flexible, community driven GraphQL client for Angular, JavaScript, and native platforms. It is designed from the ground up to make it easy to build UI components that fetch data with GraphQL. To get the most value out of Apollo Client, you should use it with one of its view layer integrations. To get started with the Angular integration, go to [setup](./v1/basics/setup).

Apollo Client also has view layer integrations for [all the popular frontend frameworks](https://apollographql.com/client). For the best experience, make sure to use the view integration layer for your frontend framework of choice.
...
Getting started is as simple as installing a few libraries from [npm](https://npmjs.org)! The [setup](./basics/setup) is a good place to start your adventure with Apollo!
