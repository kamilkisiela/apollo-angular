---
description: What is Apollo Client and what does it do?. Learn how to get started with Apollo Client.
---
...
[Apollo Client](https://nasa.gov/mission_pages/apollo/missions/index.html) is the ultra-flexible,
...
started with the Angular integration, go to [setup](./v1/basics/setup).

Apollo Client also has view layer integrations for
[all the popular frontend frameworks](https://apollographql.com/client). For the best experience,
make sure to use the view integration layer for your frontend framework of choice.

Apollo Client can be used in any JavaScript frontend where you want to describe your data using
GraphQL. It's:
...
1. **Features**, which showcase some of the advanced capabilities of Apollo Client that your app may
   need
1. **Recipes**, to isolate and explain how to do common patterns

Getting started is as simple as installing a few libraries from [npm](https://npmjs.org)! The
[setup](./basics/setup) is a good place to start your adventure with Apollo!

### Compatible Tools

We want you to love working with Apollo Client, so we work extra hard to make sure it works with the
client or server tools you're already using! The maintainers and contributors focus on solving the
hard problems around GraphQL caching, request management, and UI updating, and we want that to be
available to anyone regardless of their technical requirements and preferences for other parts of
the app.
