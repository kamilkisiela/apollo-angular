...
describe('Apollo', () => {
  describe('service', () => {
    ...
    describe('watchQuery()', () => {
      ...
      test('should be able to use obserable variable', (
        done: jest.DoneCallback
      ) => {
        const query = gql`
          query heroes($first: Int) {
            allHeroes(first: $first) {
              name
            }
          }
        `;
      ...
      test('should be able to use obserable variables', (
        done: jest.DoneCallback
      ) => {
        const query = gql`
          query heroes($first: Int, $order: String) {
            allHeroes(first: $first, order: $order) {
              name
            }
          }
        `;
      ...
      test('should receive a new result on refetch', (
        done: jest.DoneCallback
      ) => {
        const query = gql`
          query heroes($first: Int) {
